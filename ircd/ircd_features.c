 ...
 * @version $Id: ircd_features.c,v 1.9 2005/12/24 14:50:40 progs Exp $
 */
#include "config.h"
...
{
    add_isupport_s("CHANMODES", feature_bool(FEAT_OPLEVELS) ? "b,AkU,l,imnpstrDdcCN" :
    							 	"b,k,l,imnpstrDdcCN");
}
...
static struct FeatureDesc {
  ...
  F_B(SETHOST_UNSET, 0, 0, 0),
  F_B(SETHOST_AUTO, 0, 0, 0),
  F_B(HIS_STATS_s, 0, 0, 0),
  F_S(DEFCHMODES, 0, "nt", 0),
