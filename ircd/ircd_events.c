 ...
 *
 * $Id: ircd_events.c,v 1.3 2005/01/24 01:19:23 bugs Exp $
 */
#include "../config.h"
...
const char* timer_to_name(enum TimerType);
const char* event_to_name(enum EventType);
const char* gen_flags(unsigned int);
