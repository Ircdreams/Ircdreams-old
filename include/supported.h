 ...
 *
 * $Id: supported.h,v 1.15 2005/10/07 23:46:17 bugs Exp $
 *
...
#define FEATURESVALUES1 feature_int(FEAT_MAXSILES), MAXMODEPARAMS, \
			...
			feature_int(FEAT_MAXBANS), feature_int(FEAT_NICKLEN), NICKLEN, TOPICLEN, \
			AWAYLEN, TOPICLEN

#define FEATURESVALUES2 "#", "(Xohv)~@%+", "b,k,l,cdhimnopqrstvCDMNOPRTW", "rfc1459", \
