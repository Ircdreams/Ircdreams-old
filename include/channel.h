 ...
 * @version $Id: channel.h,v 1.8 2005/12/25 17:26:59 progs Exp $
 */
...
#define MODE_DELJOINS   0x1000  	/**< +D New join messages are delayed */
...
#define MODE_WASDELJOINS 0x400000 	/**< +d Not DELJOINS, but some joins
					 * pending */
#define MODE_NOCOLOR	0x800000	/**< +c Colors are not allowed */
#define MODE_NOCTCP		0x1000000	/**< +C Ctcps are not allowed */
#define MODE_NONOTICE	0x2000000	/**< +N Notices are not allowed (though, wallvoices and wallchops are still available) */
/* RESERVED             0x20000000 */
/* RESERVED             0x40000000 */
/* Les deux bits ci-dessus sont réservés à MODE_ADD et MODE_DEL. */
...
#define infochanmodes feature_bool(FEAT_OPLEVELS) ? "AbiklmnopstUvrDcCN" : "biklmnopstvrDcCN"
...
extern int client_can_send_to_channel(struct Client *cptr, struct Channel *chptr, int reveal, const char *text);
