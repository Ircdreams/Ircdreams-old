 ...
 *
 * $Id: channel.h,v 1.27 2005/11/27 21:42:25 bugs Exp $
 */
...
#define CHFL_DELAYED            0x10000  /* delayed join */
...
#define MODE_OPERONLY   	0x4000  /* Only opers may join */
...
#define MODE_ACCONLY	   	0x100000 /* Messages only from account */
#define MODE_NONOTICE   	0x200000  /* Pas de notices */
#define MODE_NOQUITPARTS 	0x400000 /* pas de message de quit */
#define MODE_DELJOINS   	0x800000
#define MODE_WASDELJOIN 	0x1000000 /* Invisible users present on channel */
#define MODE_NOAMSG             0x2000000
#define MODE_NOCAPS             0x4000000
#define MODE_NOCHANPUB		0x8000000
#define MODE_NOWEBPUB		0x10000000

/* code carateres des couleurs */
...
extern int is_chan_service(struct Client *cptr, struct Channel *chptr);
...
extern void modebuf_mode_client2(struct ModeBuf *mbuf, unsigned int mode,
                                struct Client *client);
extern void modebuf_mode_client3(struct ModeBuf *mbuf, unsigned int mode,
                                struct Client *client);
